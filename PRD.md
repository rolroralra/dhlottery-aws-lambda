...
- Terraform으로 인프라 코드화
- 실행 결과 이메일 알림 - 성공/실패 모두 (`rolroralra@gmail.com`)
...
| FR-04 | 실행 결과 이메일 알림 발송 (성공/실패 모두) | P0 |
...
| NFR-02 | 비용 | < $5/월 |
| NFR-03 | 인프라 코드화 | Terraform/OpenTofu 100% |
| NFR-04 | 알림 지연 | < 5분 |
...
- **Terraform/OpenTofu State**: S3 Backend + DynamoDB Lock
